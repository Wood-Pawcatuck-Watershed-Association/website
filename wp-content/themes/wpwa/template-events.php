                        ...
                        <?php if ($date_now < $date_expired) : ?>
                            <div class="max-w-md lg:max-w-sm px-2 mb-4 h-full mx-auto">
                                <div class="event__single">
                                    <?php if ($thumbnail): ?>
                                    <div class="h-32 flex-none bg-cover bg-center rounded-t text-center overflow-hidden" style="background-image: url(<?= $thumbnail; ?>);"></div>
                                    <?php endif; ?>
                                        ...
                                        <div class="event__details flex">
                                            <div class="event__details--right ml-2">
                                                <div class="event__details--rightInnerTop">
                                                    <h3 class="my-0 text-black font-semibold text-lg mb-4"><?= !empty($event_heading) ? $event_heading : the_title(); ?></h3>
                                                </div>
